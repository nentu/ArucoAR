        ...
        for j in main_list:
            if not (j[2][0][0], j[2][1][0]) == (0, 0):
                ...
                if j[2][3] == 0:
                    ...
                    frame = paste(frame, s_img_p, (j[2][0][0], j[2][1][0]), j[2][2])  # paste(frame,cap.read()[1],(j[2][0],j[2][1]), -1*j[2][2])
                elif j[2][3] == 1:
                    pass
                ...
                if 1:
                    if ids[i] == j[0]:
                        ...
                        if (last_pos[0][0],last_pos[1][0])!=(0,0):
                            ...
                            j[2] = [[x_cor_1,x_cor], [y_cor_1,y_cor], -1 * engle, if_image, count_space, count_life, num_of_img,marker_r]
                        else:
